...
import com.google.spartancoin.core.Utils;
...
public final class RequestWalletBalanceTask
{
	...
	{
       // log.info("preparing for ballance request wallet");
		backgroundHandler.post(new Runnable()
		{
			...
			public void run()
			{
                ...
                if(CoinParams.UnspentAPI == CoinParams.UnspentAPIType.BitEasy)
                {
                    // bitEasy format
                ...
                else if(CoinParams.UnspentAPI == CoinParams.UnspentAPIType.Blockr) {
                    // blockR format
                    int i = 0;
                    for (final Address address : addresses)
                    {
                ...
                else if(CoinParams.UnspentAPI == CoinParams.UnspentAPIType.Viho) {
                    int i = 0;
                    for (final Address address : addresses)
                    {
                        if(i != 0)
