...
import org.spartancoin.protocols.payments.Protos.PaymentACK;
...
public abstract class AcceptBluetoothThread extends Thread
{
	...
	protected static BluetoothServerSocket listen(final BluetoothAdapter adapter, final UUID uuid)
	{
		try
		{
			return adapter.listenUsingInsecureRfcommWithServiceRecord("SpartanCoin Transaction Submission", uuid);
		}
		catch (final IOException x)
		{
