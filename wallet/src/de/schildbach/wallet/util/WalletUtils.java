...
import com.google.spartancoin.core.ScriptException;
import com.google.spartancoin.core.Sha256Hash;
import com.google.spartancoin.core.Transaction;
import com.google.spartancoin.core.TransactionInput;
...
import com.google.spartancoin.store.UnreadableWalletException;
import com.google.spartancoin.store.WalletProtobufSerializer;
...
public class WalletUtils
{
	...
	public static void writeKeys(@Nonnull final Writer out, @Nonnull final List<ECKey> keys) throws IOException
	{
		...
		out.write("# KEEP YOUR PRIVATE KEYS SAFE! Anyone who can read this can spend your SpartanCoins.\n");
